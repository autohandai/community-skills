...
description: NVIDIA copyright header requirements for NeMo-RL. Covers which files
  need headers and the exact header text.
license: Apache-2.0 AND CC-BY-4.0
metadata:
  when_to_use: Adding a new file; checking copyright headers; 'missing copyright',
    'NVIDIA header', 'license header', 'is a header required here', during code review.
  author: NVIDIA
---
