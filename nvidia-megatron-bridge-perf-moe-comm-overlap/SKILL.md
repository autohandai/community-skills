...
description: MoE expert-parallel communication overlap in Megatron Bridge. Covers
  dispatch/combine overlap, flex dispatcher backends, and expert wgrad scheduling.
license: Apache-2.0 AND CC-BY-4.0
metadata:
  when_to_use: Tuning MoE communication overlap, or tracing a MoE throughput regression
    to a comm-overlap config change; 'overlap_moe_expert_parallel_comm', 'MoE dispatch
    overlap', 'flex dispatcher', 'DeepEP overlap', 'expert wgrad scheduling'.
  author: NVIDIA
---
...
- @skills/nvidia-megatron-bridge-perf-moe-comm-overlap/card.yaml
