...
monitoring), see `common/slurm-setup.md`.
...
Use the multi-node template from `common/slurm-setup.md` section 4 as the job script wrapper.
...
See `common/slurm-setup.md` section 2 for the smoke test partition pattern.
