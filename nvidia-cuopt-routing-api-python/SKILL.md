---
name: nvidia-cuopt-routing-api-python
description: Vehicle routing (VRP, TSP, PDP) with cuOpt — Python API only. Use when
  the user is building or solving routing in Python.
