...
Read @skills/nvidia-megatron-bridge-nemo-rl-e2e-testing/SKILL.md for the full workflow, environment setup, metric checks,
...
Read @skills/nvidia-megatron-bridge-verl-e2e-testing/SKILL.md for the full workflow and reporting format.
