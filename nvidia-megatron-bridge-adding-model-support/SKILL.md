...
description: Guide for adding support for new LLM or VLM models in Megatron-Bridge.
  Covers bridge, provider, recipe, tests, docs, and examples.
license: Apache-2.0 AND CC-BY-4.0
metadata:
  when_to_use: User asks to add, onboard, or integrate a new model family; 'add Qwen4
    support', 'onboard Llama 5', 'create a bridge for X', 'write a recipe for Y'.
  author: NVIDIA
---
...
- VLM: @skills/nvidia-megatron-bridge-adding-model-support/vlm-patterns.md
- LLM: @skills/nvidia-megatron-bridge-adding-model-support/llm-patterns.md
...
For detailed recipe patterns, see @skills/nvidia-megatron-bridge-adding-model-support/recipe-patterns.md.
...
For detailed test patterns, see @skills/nvidia-megatron-bridge-adding-model-support/tests-and-examples.md.
