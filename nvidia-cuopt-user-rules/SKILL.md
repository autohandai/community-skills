...
If the result required a correction, retry, or workaround to reach this point, you MUST evaluate the skill-evolution workflow (`skills/nvidia-cuopt-skill-evolution/SKILL.md`) before moving on. Do not skip this step.
