...
description: Representative MoE training playbooks by hardware platform and model
  family. Summarizes rounded throughput bands, parallelism patterns, and common tuning
  stacks.
license: Apache-2.0 AND CC-BY-4.0
metadata:
  when_to_use: Hardware-specific MoE playbooks or throughput estimates; 'MoE on H100',
    'GB200 config', 'expected throughput', 'MoE hardware playbook', 'parallelism for
    B200'.
  author: NVIDIA
---
...
Card: @skills/nvidia-megatron-bridge-perf-moe-hardware-configs/card.yaml
