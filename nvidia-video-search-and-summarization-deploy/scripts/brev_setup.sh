...
#
# Usage:
#   source skills/nvidia-video-search-and-summarization-deploy/scripts/brev_setup.sh          # verbose
#   source skills/nvidia-video-search-and-summarization-deploy/scripts/brev_setup.sh --quiet  # no stdout
#
