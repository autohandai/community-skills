...
```bash
source skills/nvidia-video-search-and-summarization-deploy/scripts/brev_setup.sh
```

Or equivalently:

```bash
source "$(claude-config-dir)/skills/nvidia-video-search-and-summarization-deploy/scripts/brev_setup.sh"
```
