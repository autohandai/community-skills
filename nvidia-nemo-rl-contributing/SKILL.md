...
description: Contribution conventions for NeMo-RL. Covers PR title format, commit
  sign-off, and CI triggering.
license: Apache-2.0 AND CC-BY-4.0
metadata:
  when_to_use: Opening a PR; writing a commit message; triggering CI; 'PR title format',
    'sign-off', 'conventional commits', 'how do I trigger CI', during code review
    of PR process.
  author: NVIDIA
---
