...
description: Validate and use MoE expert-parallel communication overlap in Megatron-Bridge,
  including overlap_moe_expert_parallel_comm, delay_wgrad_compute, and flex dispatcher
  backends such as DeepEP and HybridEP.
license: Apache-2.0 AND CC-BY-4.0
metadata:
  when_to_use: Enabling EP overlap to hide dispatch/combine latency, or tracing a
    throughput regression to an EP overlap config change; 'overlap_moe_expert_parallel_comm',
    'delay_wgrad_compute', 'flex dispatcher', 'DeepEP overlap', 'HybridEP overlap'.
  author: NVIDIA
---
...
Card: @skills/nvidia-megatron-bridge-perf-expert-parallel-overlap/card.yaml

## References

- Stable docs: @docs/training/communication-overlap.md
- Structured metadata: @skills/nvidia-megatron-bridge-perf-expert-parallel-overlap/card.yaml
