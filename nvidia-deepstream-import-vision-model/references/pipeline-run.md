...
INSPECT_OUT=$(python3 skills/nvidia-deepstream-import-vision-model/scripts/model/inspect-onnx.py "$ONNX_FILE")
...
> Use `skills/nvidia-deepstream-import-vision-model/scripts/deepstream/ds-single-stream.sh` which handles this automatically
...
bash skills/nvidia-deepstream-import-vision-model/scripts/deepstream/ds-kitti-dump.sh \
...
bash skills/nvidia-deepstream-import-vision-model/scripts/deepstream/ds-perf-run.sh \
