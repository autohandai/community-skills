...
description: Build, convert, validate, and install Autohand extensions, including Pi adaptations.
license: Apache-2.0
compatibility: Autohand Code extension manifest v1 and Agent Skills compatible clients
---
