...
description: Interactive code review for NVIDIA-NeMo/RL pull requests. Checks out
  PR locally, reads existing comments, applies coding guidelines from skills, previews
  findings, and posts review comments. Also supports reviewing the current branch
  locally.
...
metadata:
  when_to_use: Reviewing a PR; '/review-pr <number>'; 'review this PR', 'check PR',
    'code review for PR'.
